    ...
    def _name_search(self, name, args=None, operator='ilike', limit=100, name_get_uid=None):
        ...
        if name:
            ...
            if not product_ids and operator in positive_operators:
                # REPLACE
                domains = ['&',('name', operator, filters[0]),('name', operator, filters[1])]
                product_ids = list(self._search(domains + args,limit=limit,access_rights_uid=name_get_uid))
